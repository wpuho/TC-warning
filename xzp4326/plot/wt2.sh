...
grdimage data.grd -R100/160/10/45 -JQ180/9 -CSST.cpt -K       >$psname.ps
psxy $filename'.mask' -R -G100 -J -Ss0.06 -K  -O                 >>$psname.ps

pscoast -J -R -G200 -W1 -Ba10f10/a5f5WeSn -Di -O -K  >>$psname.ps

echo 157 46.4 17 0 28 6 $filename >> temp2
pstext temp2 -R -J -G255 -S10/0/0/0 -N -K -O >>$psname.ps

echo 146.5 48 15 0 28 6 'Tropical Storm 03W (Hagupit) Warning #13' >> temp2
pstext temp2 -R -J -G255 -S10/0/0/0 -N -K -O >>$psname.ps
...
psxy temp2 -R -J -O  -Ctc_scale1.cpt -Sc0.2 -Y0.2 -K  -N >> $psname.ps
psxy temp2 -R -J -O  -W8/0/0/0 -Sc0.2 -K  -N  >> $psname.ps
