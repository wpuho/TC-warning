...
# ==================== plot =====================
      ...
      surface $filename'.txt' -Gdata.grd -I0.25 -R100.125/165.125/10.125/45.125 -T0 -Z1.7

      grdsample data.grd -I0.1 -R -Gdata.grd

      grdimage data.grd -R105/165/10/45 -JQ180/9 -Cscale_SST.cpt -Y3.9 -X1 -K  >$psname.ps
...
# ================== add track ==================
      ...
      psxy $filename2'_prvs.txt' -R -J -O  -Cscale_TC.cpt -Sc0.12 -O -K  >>$psname.ps
      psxy $filename2'_prvs.txt' -R -J -O  -W4/0/0/0 -Sc0.13 -O -K  >>$psname.ps

      psxy $filename2'_fcst.txt' -R -J -O  -W7,0/0/0,-O -K  >>$psname.ps
      psxy $filename2'_fcst.txt' -R -J -O  -Cscale_TC.cpt -Sc0.12 -O -K  >>$psname.ps
      ...
      psscale -Cscale_SST.cpt -D4.5/-0.5/9/0.1h -Ba$cintaf$cintf::/:"@+o@+C": -E -O -K  >>$psname.ps
...
# ================== plot legend ================
      ...
      echo 107 45 34  >temp2
      echo 112 45 64  >>temp2
      echo 117 45 83  >>temp2
      echo 122 45 96  >>temp2
      echo 127 45 114  >>temp2
      echo 132 45 136  >>temp2

      psxy temp2 -R -J -Cscale_TC.cpt -Sc0.2 -Y0.2 -N -O -K  >>$psname.ps
      psxy temp2 -R -J -W8/0/0/0 -Sc0.2 -N -O -K  >>$psname.ps

      echo 107 46 14 0 0 2 TD/TS  >temp2
      echo 112 46 14 0 0 2 Cat.1  >>temp2
      echo 117 46 14 0 0 2 Cat.2  >>temp2
      echo 122 46 14 0 0 2 Cat.3  >>temp2
      echo 127 46 14 0 0 2 Cat.4  >>temp2
      echo 132 46 14 0 0 2 Cat.5  >>temp2
